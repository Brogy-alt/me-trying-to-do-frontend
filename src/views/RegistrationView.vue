        ...
        <div class="row">
            <div class="col">
                <form class="form" @submit.prevent="signUp">
                  ...
                  <div class="form-control-wrapper">  
                      <span class="inline">
                        <input type="text" class="form-control" placeholder="Gender" v-model="payload.gender" maxlength="10">
                  ...
                  <div class="form-control-wrapper">  
                      ...
                      <div class="form-control-wrapper">  
                      <span class="inline">
                        <input type="text" class="form-control" placeholder="User Role" v-model="payload.userRole">
                        <i class="bi bi-person-fill"></i>
                      </span>        
                  </div>
                  <div class="form-control-wrapper">  
